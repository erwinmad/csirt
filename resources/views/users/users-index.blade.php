            ...
            <div>
              <div class="d-flex flex-wrap pt-2 justify-content-between sales-header-right">
                <div class="d-flex mr-5">
                  ...
                  <div class="pl-2">
                    <h4 class="mb-0 font-weight-semibold head-count"> {{ $countApps }} </h4>
                    <span class="font-10 font-weight-semibold text-muted">Aplikasi</span>
                  </div>
                </div>
                <div class="d-flex mr-3 mt-2 mt-sm-0">
                  ...
                  <div class="pl-2">
                    <h4 class="mb-0 font-weight-semibold head-count"> {{ $countWebsite }} </h4>
                    <span class="font-10 font-weight-semibold text-muted">Website</span>
                  </div>
                </div>
              </div>
            </div>
