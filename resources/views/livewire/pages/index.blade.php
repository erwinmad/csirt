...
with(fn (ChartServices $appService) => [
    'countSkpd' => DB::table('daftar_skpd')->count(),
    'countApps' => DB::table('daftar_aplikasi')->count(),
    'countApps' => DB::table('jenis')->count(),
    'countWebsite' => DB::table('daftar_skpd')->whereNotNull('website_skpd')->count(),
    'countAduan' => DB::table('aduan_siber')->count(),
